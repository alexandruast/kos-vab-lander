...
GLOBAL PAD_LONGITUDE IS -74.5576726244574.
...
GLOBAL LND_LATITUDE IS    0.079.
GLOBAL LND_LONGITUDE IS -74.632.
GLOBAL LND_ELEVATION IS  64.75.
GLOBAL LND IS LATLNG(LND_LATITUDE, LND_LONGITUDE).
